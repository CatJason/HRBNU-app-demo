package com.example.jason.mxlake.paint;
...
public class MiClockView extends View {
    ...
    public MiClockView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mLightColor = ta.getColor(R.styleable.MiClockView_lightColor, Color.parseColor("#000000"));
        mClockColor = ta.getColor(R.styleable.MiClockView_clockColor, Color.parseColor("#000000"));
        mDarkColor = ta.getColor(R.styleable.MiClockView_darkColor, Color.parseColor("#80000000"));
        ...
        mScaleLinePaint.setColor(mClockColor);
